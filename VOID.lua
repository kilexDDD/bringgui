...
Credits.Text = "Void Gui made by Kilex"
...
workspace.Light.CFrame = CFrame.new(game.Players.LocalPlayer.Character.Torso.Position)
    	wait(1.50)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(9999999,-99999999999,999999)
    end)
