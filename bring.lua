...
h.Anchored = true
h.CFrame = CFrame.new(game.Players.LocalPlayer.Character.Torso.Position)
h.CanCollide = false
h.Transparency = 1
h.Size = Vector3.new(1, 1.2, 1)
...
ATPGUI.Name = "BringGui"
ATPGUI.Parent = game.CoreGui
...
Credits.Text = "Bring Gui made by Kilex"
...
local function RFIR_fake_script() -- TextButton.LocalScript 
	...
	function Clicked() 
		...
		local pl2 = game.CoreGui.BringGui.MainFrame.TextButton.TextBox.Text
...
workspace.BringPart.CFrame = CFrame.new(game.Players.LocalPlayer.Character.Torso.Position)
    	wait(1.50)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.BringPart.CFrame
    wait(4)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.BringPart.CFrame
end)
